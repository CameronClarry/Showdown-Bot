...
CREATE TABLE wl_lb(id VARCHAR(20) PRIMARY KEY NOT NULL, correct INTEGER NOT NULL, incorrect INTEGER NOT NULL, passed INTEGER NOT NULL, wins INTEGER NOT NULL, banked INTEGER NOT NULL, won INTEGER NOT NULL);
