...
`~ttl remove, [user]`|This subtracts the given number of points from the given user's scores. This affects all enabled leaderboards.|@
`~ttl removeuser, [user]`|Removes the specified user from all leaderboards.|@
